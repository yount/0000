...
create table SCProductEntry (
	...
	type_ varchar(75),
	tags varchar(255),
	shortDescription varchar(750),
	longDescription varchar(750),
	pageURL varchar(750),
	author varchar(75),
...
create table SCProductVersion (
	...
	productEntryId bigint,
	version varchar(75),
	changeLog varchar(750),
	downloadPageURL varchar(750),
...
create table ShoppingCoupon (
	...
	endDate timestamp,
	active_ smallint,
	limitCategories varchar(750),
	limitSkus varchar(750),
	minOrder double,
	discount double,
...
create table ShoppingItem (
	...
	name varchar(200),
	description varchar(750),
	properties varchar(750),
	fields_ smallint,
	fieldsQuantities varchar(750),
	minQuantity integer,
	maxQuantity integer,
	price double,
	discount double,
	...
	mediumImageURL varchar(750),
	largeImage smallint,
	largeImageId bigint,
	largeImageURL varchar(750)
);
...
create database lportal1 pagesize 8192;
connect to lportal1;
create table Account_ (
	accountId bigint not null primary key,
	companyId bigint,
...
create database lportal2 pagesize 8192;
connect to lportal2;
create table Account_ (
	accountId bigint not null primary key,
	companyId bigint,
